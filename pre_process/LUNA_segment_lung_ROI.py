...
def segment_lungs(dataset_path):
    ...
    for img_file in tqdm(file_list):
        ...
        for i in range(len(imgs_to_process)):
            ...
            # to renormalize washed out test
        ...
        img_file_end = img_file.split('\\')[-1]
        np.save(img_file.replace(img_file_end, img_file_end.replace("images", "lungmask")),imgs_to_process)
    ...
    for fname in file_list:
        ...
        for i in range(len(imgs_to_process)):
            ...
            if max_row-min_row < 5 or max_col-min_col< 5:  # skipping all test with no god regions
                pass
            else:
    ...
    #
    #  Writing out test and masks as 1 channel arrays for input into network
    #
